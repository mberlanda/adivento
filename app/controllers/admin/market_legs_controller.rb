module Admin
  class MarketLegsController < BaseController
    ...
    def create
      ...
      return render json: { error: 'Market already has 2 legs' }, status: :unprocessable_content if market.market_legs.count >= 2
      ...
      if leg.save
        ...
        render json: { errors: leg.errors.full_messages }, status: :unprocessable_content
      end
    end
