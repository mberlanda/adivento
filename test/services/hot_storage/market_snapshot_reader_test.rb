...
class ErrorRedis
  def set(*) = raise('Redis connection lost')
  def get(*) = raise('Redis connection lost')
  def xadd(*) = raise('Redis connection lost')
end

module HotStorage
  class MarketSnapshotReaderTest < ActiveSupport::TestCase
    setup do
